...
public class BleNamesResolver {
	...
	static {
		...
		mServices.put("eb864180-d0e7-40ac-8b2d-b6750215f426", "Heart Rate");
		mServices.put("6e400001-b5a3-f393-e0a9-e50e24dcca9e", "Temperature Sensor");
		mServices.put("a9428af1-ed54-4ae7-a5ac-92a7a0a498f9'", "Wifi & Password");
...
//		mCharacteristics.put("00002a39-0000-1000-8000-00805f9b34fb", "Heart Rate Control Point");
		mCharacteristics.put("6e400003-b5a3-f393-e0a9-e50e24dcca9e", "Temperature Measurement");
		mCharacteristics.put("eb864182-d0e7-40ac-8b2d-b6750215f426", "Heart Rate Measurement");
